# -*- coding: utf-8 -*-
# app.py — ADI Builder (Safe Build • Icons optional • Segmented/Radio fallback)
...
# ------------------------------------------------------------------
# Config: icons can be turned off with env var ADI_ICONS=0
...
/* Segmented control styling (if available) */
...
with tabs[1]:
    ...
    # Robust: segmented control if available, else radio
    if hasattr(st, "segmented_control"):
        ...
        bloom_level = st.radio("Pick focus level", BLOOM_LEVELS, index=1, horizontal=True)
